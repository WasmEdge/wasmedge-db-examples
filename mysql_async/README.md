...
wasmedge --env "DATABASE_URL=mysql://user:passwd@127.0.0.1:3306/mysql" target/wasm32-wasip1/debug/crud.wasm
```
...
```bash
cargo build --target wasm32-wasip1
wasmedge --env "DATABASE_SSL=1" --env "DATABASE_URL=mysql://user:passwd@rds.azure.ipaddr:3306/mysql" target/wasm32-wasip1/debug/crud.wasm
```
